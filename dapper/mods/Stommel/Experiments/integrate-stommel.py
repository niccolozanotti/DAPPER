...
T, = axs.plot(time, v[:,0],linestyle='solid',linewidth=1.2,color="lime")
S, = axs.plot(time, v[:,1],color='dodgerblue',linestyle='solid',linewidth=1.2)
...
axs.set_ylabel('$T,S \, [,ppt]$',fontsize=9)
