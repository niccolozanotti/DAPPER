...
T_dev_min, T_dev_max, T_dev_step = 1.5, 3.0, 0.5
S_dev_min, S_dev_max, S_dev_step = 1.5, 3.0, 0.5
T_dev = np.arange(T_dev_min, T_dev_max, T_dev_step)
S_dev = np.arange(S_dev_min, S_dev_max, S_dev_step)
...
fig.savefig(os.path.join(stommel.fig_dir,'ref_forcing_var.png'),format='png',dpi=500)